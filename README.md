...
I am in the same situation. And I applied my Engineering Brain to solve this problem.
 ...
 Scenario 2 : 
Suppose you are getting bored. You want to watch a movie on youtube or listen to a song or send an email or play a game or chat with friends on facebook or peep into instagram or tweet on twitter or upload this code on Github:) or this or that and so on..............
Infinite scenarios...
...
Currently, it can do the following stuff : 
1) Open Gmail
2) Start video player
3) Start Microsoft Word
4) Open Google Play Music
5) Open Devpost.com
...
Built the project in 4 days ( and nights) !!!
...
4) How to build an app in 4 days
